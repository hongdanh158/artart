        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <form method="POST" action="/register" id="dinhkemform" enctype="multipart/form-data">
                    <p class="note">(*) Bắc buộc nhập thông tin!</p>
                    <div class="row registerform">
                        ...
                        <div class="col-md-12">
                            <textarea id="" class="form-control" rows="2" placeholder="Ghi chú"></textarea>
                        </div>
                        <div class="col-md-12 text-center">
                            <button class="btn btn-primary">Đồng ý thanh toán</button> &nbsp;
            ...
            <div class="col-md-6">
                ...
                <p class="note text-center">Khách hàng đăng nhập tài khoản để quản lý đơn hàng!</p>
                <form method="POST" action="/register" id="dinhkemform" enctype="multipart/form-data">
                    <div class="row login">
                        <input type="text" class="form-control" placeholder="(*) Địa chỉ email">
                        ...
                        <div class="col-md-12 text-center">
                            ...
                            <a href="#" class="btn btn-success">Đăng ký tài khoản</a>
                        </div>
                    </div>
                </form>
            </div>
